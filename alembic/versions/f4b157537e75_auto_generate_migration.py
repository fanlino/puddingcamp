...
Revision ID: f4b157537e75
Revises: 
Create Date: 2025-12-27 23:30:58.973523
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('provider_id', sqlmodel.sql.sqltypes.AutoString(length=10), nullable=False),
